...
public class LabradorImagesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String token = SignupActivity.getTokenFromPreference(LabradorImagesActivity.this, "TOKEN");
        ...
        Call<DogResponsePojo> call = service.getDogResponse(map, "labrador");
        call.enqueue(new Callback<DogResponsePojo>() {
            ...
            public void onFailure(Call<DogResponsePojo> call, Throwable t) {
                Toast.makeText(LabradorImagesActivity.this, "Something went wrong", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void generateUrlImageList(List<String> urlImageList) {
        ...
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(LabradorImagesActivity.this);
