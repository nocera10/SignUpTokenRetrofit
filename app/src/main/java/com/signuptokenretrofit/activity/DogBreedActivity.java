...
public class DogBreedActivity extends AppCompatActivity {
    ...
    public void houndButtonAction(View v) {
        Intent intent = new Intent(DogBreedActivity.this, HoundImagesActivity.class);
        startActivity(intent);
    }

    public void pugButtonAction(View v) {
        Intent intent = new Intent(DogBreedActivity.this, PugImagesActivity.class);
        startActivity(intent);
    }

    public void labradorButtonAction(View v) {
        Intent intent = new Intent(DogBreedActivity.this, LabradorImagesActivity.class);
        startActivity(intent);
    }
}
