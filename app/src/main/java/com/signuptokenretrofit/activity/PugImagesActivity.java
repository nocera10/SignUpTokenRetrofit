...
public class PugImagesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String token = SignupActivity.getTokenFromPreference(PugImagesActivity.this, "TOKEN");
        ...
        Call<DogResponsePojo> call = service.getDogResponse(map, "pug");
        call.enqueue(new Callback<DogResponsePojo>() {
            ...
            public void onFailure(Call<DogResponsePojo> call, Throwable t) {
                Toast.makeText(PugImagesActivity.this, "Something went wrong", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void generateUrlImageList(List<String> urlImageList) {
        ...
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(PugImagesActivity.this);
