...
public class HoundImagesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String token = SignupActivity.getTokenFromPreference(HoundImagesActivity.this, "TOKEN");
        ...
        Call<DogResponsePojo> call = service.getDogResponse(map, "hound");
        call.enqueue(new Callback<DogResponsePojo>() {
            ...
            public void onFailure(Call<DogResponsePojo> call, Throwable t) {
                Toast.makeText(HoundImagesActivity.this, "Something went wrong", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void generateUrlImageList(List<String> urlImageList) {
        ...
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(HoundImagesActivity.this);
